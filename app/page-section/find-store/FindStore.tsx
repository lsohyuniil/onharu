        ...
        <div className="flex flex-wrap justify-center gap-2.5 md:gap-20">
          {StoreMenu.map(items => (
            ...
            >
              ...
              <span className="md:text-md inline-block rounded-full border border-gray-300 px-2.5 py-0.5 text-center text-xs font-bold shadow-[-1px_3px_10px_rgba(0,0,0,0.03)] duration-200 group-hover:bg-gray-50 md:px-7 md:py-1.5">
                {items.name}
              </span>
            </Link>
          ))}
